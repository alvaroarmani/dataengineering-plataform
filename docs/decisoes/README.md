...
Cada arquivo registra **uma decisão**: contexto, decisão, consequências. Assim o
*porquê* de cada escolha fica documentado e revisável.

| ADR | Decisão |
|---|---|
| [0001](0001-jupyter-book.md) | Plataforma: Jupyter Book + JupyterLite + Docker |
| [0002](0002-correcao-pytest.md) | Correção via "faça o pytest passar" |
