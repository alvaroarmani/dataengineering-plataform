"""Testes do Exercício 04 (M4). Faça todos passarem: pytest -q"""
import sys
...
def test_top_por_estado(con):
    assert con.execute(CONSULTA_A).fetchall() == [
        ("SP", 12, 1500.0), ("RJ", 9, 900.0), ("MG", 8, 600.0),
    ]


def test_receita_por_estado_window(con):
